...
$$
\begin{align*}
dF_x &= p \, dy \, dz - \left(p + \frac{\partial p}{\partial x} dx\right) dy \, dz = -\frac{\partial p}{\partial x} dx \, dy \, dz, \\
dF_y &= -\frac{\partial p}{\partial y} dx \, dy \, dz, \\
dF_z &= -\frac{\partial p}{\partial z} dx \, dy \, dz.
\end{align*}
$$
